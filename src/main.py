...
from shortest_way import shortest_way_through_cells, the_shortest_way, raycast
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            points1 = the_shortest_way((player.rect.x, player.rect.y), event.pos, obstacle_map, level_x, level_y, camera.sum_dx, camera.sum_dy)
    ...
    if points:
        ...
        pygame.draw.lines(screen, (0, 255, 255), False, points1)
    pygame.display.flip()
    clock.tick(FPS)
